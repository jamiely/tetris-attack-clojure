...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21737 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21737(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21738 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21738(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21740 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21740(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21741 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21741(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21742 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21742(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21745 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21745(reader);
}
});
...
var G__21773 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21774 = s.append(c);
c = G__21773;
s = G__21774;
continue;
}
