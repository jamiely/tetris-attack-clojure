...
var i_28014 = (0);
while(true){
if((i_28014 < arr.length)){
(arr[i_28014] = null);

var G__28015 = (i_28014 + (1));
i_28014 = G__28015;
continue;
} else {
}
...
var i_28022 = (self__.level + (1));
while(true){
if((i_28022 <= (new_level + (1)))){
(update[i_28022] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_28024 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28024[i]));
} else {
x__$2.forward.push((((i < links_28024.length))?(links_28024[i]):null));
}

if((i < links_28024.length)){
(links_28024[i] = x__$2);
} else {
links_28024.push(x__$2);
}
...
var i_28027 = (0);
while(true){
if((i_28027 <= self__.level)){
var links_28028 = (update[i_28027]).forward;
if((x__$1 === (((i_28027 < links_28028.length))?(links_28028[i_28027]):null))){
(links_28028[i_28027] = (x__$1.forward[i_28027]));

var G__28030 = (i_28027 + (1));
i_28027 = G__28030;
continue;
} else {
var G__28031 = (i_28027 + (1));
i_28027 = G__28031;
continue;
}
} else {
