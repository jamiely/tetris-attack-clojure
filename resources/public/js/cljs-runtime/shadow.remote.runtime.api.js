...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28204 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28204(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_28208 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_28208(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_28215 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_28215(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_28220 = (function (thing,opts){
...
var meta_impl__5352__auto__ = temp__5823__auto__;
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_28220(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28229 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28229(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28232 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28232(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__28195,callback){
var map__28196 = p__28195;
var map__28196__$1 = cljs.core.__destructure_map(map__28196);
var input = map__28196__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28196__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28196__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
