...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26333 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26333(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26334 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26334(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26335 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26335(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26341 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26341(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26343 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26343(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26344 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26344(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26352 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26352(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26361 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26361(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26364 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26364(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26377 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26377(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26381 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26381(b);
}
});
